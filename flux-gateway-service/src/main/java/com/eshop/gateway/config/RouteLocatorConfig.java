  ...
  public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
    return builder.routes()
      .route(CATALOG_QUERY_ROUTE_ID, r -> r
        ...
        .uri(uriFor(eshopServices.getCatalogQuery()))
      )
      .route(CATALOG_COMMAND_ROUTE_ID, r -> r
        ...
        .filters(f -> f
          .removeRequestHeader(COOKIE_HEADER_NAME) // Prevents cookie being sent downstream
          .rewritePath(API_PATH, ""))
        .uri(uriFor(eshopServices.getCatalogCommand()))
      )
      .route(BASKET_ROUTE_ID, r -> r
        ...
        .uri(uriFor(eshopServices.getBasket()))
      )
      .route(ORDERS_ROUTE_ID, r -> r
        ...
        .uri(uriFor(eshopServices.getOrderProcessing()))
      )
      .route(RATING_ROUTE_ID, r -> r
        ...
        .uri(uriFor(eshopServices.getRating()))
      )
      .build();
  }

  private String uriFor(String serviceName) {
