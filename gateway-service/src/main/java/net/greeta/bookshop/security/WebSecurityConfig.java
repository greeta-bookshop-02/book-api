...
public class WebSecurityConfig {
    ...
    public SecurityWebFilterChain securityFilterChain(ServerHttpSecurity http) {
        return http
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers("/order/api", "/order/api/**").permitAll()
    ...
    public static final String BOOKSHOP_MANAGER = "BOOKSHOP_MANAGER";
    public static final String BOOKSHOP_USER = "BOOKSHOP_USER";
}
